...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		id = "assets/images/Enemigo01.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Enemigo02.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Enemigo03.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Enemigo04.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Escudos.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/images-go-here.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/morir.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
